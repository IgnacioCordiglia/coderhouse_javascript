class Partido {
    ...
    actualizar() {
        if(golesLocales!=null && golesVisitantes!=null) {
            ...
            this.golesLocal>this.golesVisitante ? (this.visitante.PP++, this.local.PG++) : null;
            //si gana el visitante, se le suma un partido ganado y un partido perdido al local
            this.golesVisitante>this.golesLocal ? (this.visitante.PG++,this.local.PP++) : null;
            //si empatan, se le suma un partido empata a c/u
            this.golesLocal==this.golesVisitante ? (this.local.PE++, this.visitante.PE++) : null;
    ...
    borrarPartido() {
        if(this.golesLocal!=null && this.golesVisitante!=null) {
            ...
            this.golesVisitante==this.golesLocal ? (this.visitante.PE--, this.visitante.PE--): null;
    
            //se le quitan los goles metidos y concedidos a los goles a favor y en contra de cada equipo
            this.local.GF-= parseInt(this.golesLocal);
            this.visitante.GF-= parseInt(this.golesVisitante);
            this.local.GC-= parseInt(this.golesVisitante);
            this.visitante.GC-= parseInt(this.golesLocal);
